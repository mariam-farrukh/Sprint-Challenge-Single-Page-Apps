...
> Answer: Client Side Routing is the browser taking care of the "url" history. The routing is taking place as your app is rendering, not in some configuration outside of the normal rendering process. Gives faster load times, and the screen does not flash white when loading.

- [X] What does AJAX stand for?

> Answer: AJAX stands for asynchronous JavaScript and XML. It is used on the client side to create asynchronous web applications.

- [X] What are `controlled components` in React?

> Answer: A controlled component is a value of the form element that is controlled by React.

- [X] Name three tools/libraries for making AJAX requests.

> Answer: Axios, Fetch, and request are used to make AJAX requests.
